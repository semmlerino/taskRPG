# modules/ui/components/choices_panel.py

from PyQt5.QtWidgets import QWidget, QPushButton, QHBoxLayout
from PyQt5.QtGui import QFont
from PyQt5.QtCore import Qt
from typing import List, Dict, Any, Callable  # Added 'Any' here
...
class ChoicesPanel(QWidget):
    ...
    def display_choices(self, choices: List[Dict[str, Any]], choice_callback: Callable):
        """Creates and displays choice buttons based on the provided choices."""
        self.clear_choices()
        for choice in choices:
            ...
            # Connect the button to the callback with the current choice
